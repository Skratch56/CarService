...
<link rel="icon" href="black.jpg">
    ...
    <body>
        ...
        <div class="container">
            <?php
        if (isset($_GET['searchCustMSG']) == 'Not Found') {
        ...
        ?>
                        ...
                        <div class="row" id="marg-top-20">
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <?php
                                        echo '<input type="text" class="form-control" name="booking" id="booking" required="true" placeholder="Enter Id Number" />'
                                        ?>
                                    </div>
            ...
            if (isset($_POST['btnsavebooking'])) {
                ...
                $query2 = "Select * from customer where idnumber='{$Booking}'";

                $result2 = mysqli_query($conn, $query2);
                if (mysqli_fetch_array($result2) > 0) {

                    echo" <script language='JavaScript' type='text/javascript' >
					 window.location.href ='booking.php?cst={$Booking}'
					</script>";
                } else {
                   header("Location: searchCustomer.php?searchCustMSG='Not Found'");
