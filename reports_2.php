            ...
            <div class="content">
                ...
                <form class="form-inline" method="get">
                    <div class="form-group">
                        <select name="filter" class="form-control" onChange="form.submit()">
                            <option value="0">Filter Booking Data</option>
                            ...
                            ?>>In Service</option>
                            <option value="In Evaluation" <?php
                            if ($filter == 'In Evaluation') {
                                echo 'selected';
                            }
                            ?>>In Evaluation</option>
                ...
                <div class="table-responsive">
                    <table class="bordered">
                        ...
                        <?php
                        if ($filter) {
                            $sql = mysqli_query($conn, "SELECT * FROM booking WHERE status='$filter'");
                        } else {
                            $sql = mysqli_query($conn, "SELECT * FROM booking ORDER BY booking_id ASC");
                        }
						...
						<tr>
							...
							<td>';
                                        if ($row['status'] == 'In Service') {
                                            echo '<span class="label label-success">In Service</span>';
                                        } else if ($row['status'] == 'In Evaluation') {
                                            echo '<span class="label label-info">In Evaluation</span>';
                                        }
                                        echo '
							</td>
							<td>
								<a href="printReport_2.php?booking_id=' . $row['booking_id'] . '" title="Edit Data" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-print" aria-hidden="true"></span></a>
							</td>
						</tr>
						';
                                        $no++;
                    ...
                    <div class="col-md-2 padding-top-10">
                        <a href="printReport_2.php" title="Edit Data" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Print All</a>
                    </div>
                    <div class="col-md-2 padding-top-10">
