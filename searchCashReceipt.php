...
<link rel="icon" href="black.jpg">
    ...
    <body>
        ...
        <div class="container">
            <div id="msg" class="alert alert-danger alert-dismissable" style="display:none;" style="visibility:hidden;"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Cash Receipt Not Found.</div>
            <div class="panel panel-default">
                <div class="panel-heading">Enter Cash Receipt Details</div>
                <div class="panel-body">
                    ...
                    <form  id="evaluatedService" name="evaluation" method="POST">
                        <div class="row" id="marg-top-20">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-4 padding-top-5" align="right">
                                        Cash Receipt No:
                                    </div>

                                    <div class="col-md-5">
                                        <?php
                                        echo '<input type="text" class="form-control" name="booking" id="booking" required="true" placeholder="Enter Cash Receipt No" />'
                                        ?>
                                    </div>
            ...
            if (isset($_POST['btnsavebooking'])) {
                ...
                $query2 = "Select * from Cash_Receipt where Cash_Receipt_No='{$Booking}'";

                $result2 = mysqli_query($conn, $query2);
                if (mysqli_num_rows($result2) > 0) {
                    while ($row = mysqli_fetch_array($result2)) {
                        $jid = $row['job_no'];
                        header("Location: cashreceipt2.php?jid={$jid}");
                    }
