            ...
            <div class="content">
                ...
                <form class="form-inline" method="get">
                    <div class="form-group">
                        <select name="filter" class="form-control" onChange="form.submit()">
                            <option value="0">Filter Customer Data</option>
                ...
                <div class="table-responsive">
                    <table class="bordered">
                        ...
                        <?php
                        if ($filter) {
                            $sql = mysqli_query($conn, "SELECT * FROM customer WHERE gender='$filter'");
                        } else {
                            $sql = mysqli_query($conn, "SELECT * FROM customer ORDER BY customer_id ASC");
                        }
						...
						<tr>
							...
							<td>' . $row['first_name'] . ' '. $row['surname'] .'</a></td>
                            <td>' . $row['gender'] . '</td>
                            <td>' . $row['idnumber'] . '</td>
							...
							<td>';
                                if ($row['gender'] == 'Male') {
                                    echo '<span class="label label-success">Male</span>';
                                } else if ($row['gender'] == 'Female') {
                                    echo '<span class="label label-info">Female</span>';
                                }
                                echo '
							</td>
							<td>
								<a href="printReport_3.php?customer_id=' . $row['customer_id'] . '" title="Edit Data" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-print" aria-hidden="true"></span></a>
							</td>
						</tr>
						';
                                $no++;
