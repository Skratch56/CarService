                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Please enter your employee number to reset your password</h4>
                        </div>

                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6 padding-top-10">
                                    <input type="text" class="form-control" id="modalempno" name="modalempno" placeholder="Employee Number" required="true" /><!-- InputBox to enter employee number -->	
                                </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-4 padding-top-8">
                                    <input type="text" class="form-control" id="reset_answer" name="reset_answer" placeholder="Answer" required="true" /><!-- InputBox to enter employee number -->	
                                </div>
                    ...
                    <div class="jumbotron" align="center">
                        ...
                        <form action="index.php" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 padding-top-10">
                                    <input type="text" class="form-control" id="staffno" name="staffno" placeholder="Employee Number" required="true" />
                                </div>				
                                <div class="col-md-3">						
                                </div>
                            </div>
                                                    ...
                                                    if (strlen($_POST['staffno']) == 0) {
                                                        ...
                                                        if ($found == false) {
                                                            if ($staffnofound == false) {
                                                                echo '<div class="alert alert-danger alert-dismissable" style="transform: translate(50%, 50%);">Employee number entered is incorrect!</div>';
                                                            } else {
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 padding-top-5">
                                    Customer Login <br>
                                    Click <a href="index1.php" >here</a>
                                </div>
                                <div class="col-md-3 padding-top-10">
                                </div>
                            </div>
