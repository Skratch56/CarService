...
<link rel="icon" href="black.jpg">
        ...
        <div class="container" id="navigationbar">
            <ul class="nav navbar-nav navbar-right">
                <ul class="breadcrumb list-inline">
                    ...
                    <li><a href="index1.php"><span class="glyphicon glyphicon-off"></span>&nbspLogout </a></li>
                </ul>
            </ul>
        </div>
                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                        <label class="control-label" for="HexInput1"> 
                            &nbsp&nbsp<input onclick="update(this.value);" type="radio" name="data[hexInput]" id="HexInput1" checked="true" value="existingcar"> Existing Vehicle
    ...
    <script language="JavaScript" type="text/javascript">
                        function getBookingPage() {
                            window.location.href = "bookingCustomer.php?cst=" + <?php echo $cust_idno; ?>;
                        }
    </script>
