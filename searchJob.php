...
<link rel="icon" href="black.jpg">
    ...
    <body>
        ...
        <div class="container">
               <div id="msg" class="alert alert-danger alert-dismissable" style="display:none;" style="visibility:hidden;"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Job Already has job cards.</div>
            <div class="panel panel-default">
                <div class="panel-heading">Enter Job Details</div>
                        ...
                        <div class="row" id="marg-top-20">
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <?php
                                        echo '<input type="text" class="form-control" name="booking" id="booking" required="true" placeholder="Enter Job" />'
                                        ?>
                                    </div>
            ...
            if (isset($_POST['btnsavebooking'])) {
                ...
                $query2 = "Select * from job where job_no='{$Booking}'";

                $result2 = mysqli_query($conn, $query2);
                if (mysqli_fetch_array($result2) > 0) {
                    $query3 = "Select * from job_card where job_no='{$Booking}'";
					...
					var div = document.getElementById('msg');
					 ...
					 window.location.href ='jobcard.php?jid={$Booking}'
					</script>";
                    }
