	...
	<body>
		...
		<div class="container">
			...
			<div class="panel panel-default">
				<div class="panel-heading">Retrieve Customer Account</div>
			...
			<div class="panel panel-default">
				...
				*/
				if (isset($_POST['btnsave'])) {
						...
						echo '<script>
							document.getElementById("balance").value = "'.$_POST['balance'] .'";
						</script>';
