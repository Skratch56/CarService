...
<div class="container">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">Retrieve Customer</div>
                ...
                <div class="row" id="marg-top-50">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="idno2" id="idno2" required="true" value="<?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 padding-top-5">
                                <input type="text" maxlength="60" class="form-control" name="firstname" id="firstname" required="true" value="<?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 padding-top-5">
                                <input type="text" class="form-control" name="surname" id="surname" required="true" value="<?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 padding-top-5">
                                <input type="text" maxlength="10" class="form-control" name="gender" id="gender" required="true" value="<?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 padding-top-5">
                                <input type="text" class="form-control" name="phone" id="phone" required="true" value="<?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 padding-top-5">
                                <input type="text" class="form-control" name="email" id="email"  required="true" value="<?php
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row padding-top-10">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="street" id="street" required="true"  value="<?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 padding-top-5">
                                <input type="text" maxlength="60" class="form-control" name="city" id="city" required="true" value="<?php
                                            if (isset($_POST['city'])) {
                                                echo $_POST['city'];
                                            }
                                            ?>" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 padding-top-5">
                                <input type="text" maxlength="10" class="form-control" name="areacode" id="areacode" required="true" value="<?php
